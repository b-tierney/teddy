...
get_metadata_healthy_pret1d = function(metadata,filter_by_time,times,HLA_status) {
  ...
  data_subj_condition = data[,c("SubjectID","condition")]
  data_subj_condition$condition = as.factor(data_subj_condition$condition)
  set.seed(3456)
  trainIndex <- createDataPartition(data_subj_condition$condition, p = .66, 
                                    list = FALSE, 
                                    times = 1)
  train_subjects <- data_subj_condition[ trainIndex,]$SubjectID
  test_subjects  <- data_subj_condition[-trainIndex,]$SubjectID
  

  if(filter_by_time == "yes") {
    times_in_months = round(times/30)
    time_out = paste(sapply(times_in_months,function(x) paste(x,"month",sep="")),collapse="-")
    write.csv(data,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',time_out,"-",HLA_status,".csv",sep=""))
    write.csv(mapping_file,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',time_out,"-",HLA_status,".mapping.csv",sep=""),row.names=FALSE)
    write.table(train_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',time_out,"-",HLA_status,".train_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
    write.table(test_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',time_out,"-",HLA_status,".test_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
      } else {
    write.csv(data,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',HLA_status,".csv",sep=""))
    write.csv(mapping_file,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',HLA_status,".mapping.csv",sep=""),row.names=FALSE)
    write.table(train_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',HLA_status,".train_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
    write.table(test_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/healthy_pre-t1d-',HLA_status,".test_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
  }
}
...
get_metadata_healthy_pre_antibody = function(metadata,filter_by_time,times,antibody_type) {
  ...
  if(filter_by_time == "yes") {
    ...
    write.table(train_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/',main_cat_prefix,"-",time_out,".train_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
    write.table(test_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/',main_cat_prefix,"-",time_out,".test_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
    ...
    write.table(train_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/',main_cat_prefix,".train_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
    write.table(test_subjects,paste('~/Dropbox (HMS)/Kostic_Lab/datasets/TEDDY/TEDDY_analysis_v2_march_2022/processed_teddy_metadata_for_regression_march9_2022/',main_cat_prefix,".test_subjects.txt",sep=""),row.names=FALSE,col.names=FALSE,quote=FALSE)
  }
}
