...
Rscript /n/data1/joslin/icrb/kostic/szimmerman/TEDDY_analysis/scripts/run_lasso_binary.R ${test_abundance_data} ${train_abundance_data} ${metadata_train} ${metadata_test} ${train_sujbects1} ${train_sujbects2} ${train_sujbects3} ${test_subjects} ${feature_list} ${features_to_keep} ${microbiome_features} ${number_threads} ${loss_function}
