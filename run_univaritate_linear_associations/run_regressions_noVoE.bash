...
while read p
do
    Rscript /n/data1/joslin/icrb/kostic/szimmerman/TEDDY_analysis/scripts/run_regressions_noVoE.R $p healthy_*_1_metadata_filtered.rds ${2} ${proportion_min_samples_abundant_in}
done < datalocs
