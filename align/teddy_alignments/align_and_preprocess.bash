...
while read dirname
do
prefetch --force no --ngc /n/data1/joslin/icrb/kostic/szimmerman/TEDDY_alignments/prj_20109.ngc -O ${output_folder}/${dirname} $dirname
fastq-dump --split-files --ngc /n/data1/joslin/icrb/kostic/szimmerman/TEDDY_alignments/prj_20109.ngc --outdir ${output_folder}/${dirname} ${output_folder}/${dirname}/${dirname}_dbGaP-20109.sra
# remove sra file
